...
namespace DFC.App.JobProfileSkills.UnitTests.ControllerTests.SegmentControllerTests
{
    public class SegmentControllerIndexTests : BaseSegmentController
    {
        ...
        public async void ReturnsSuccessForHtmlMediaType(string mediaTypeName)
        {
            ...
            A.CallTo(() => JobProfileSkillSegmentService.GetAllAsync()).Returns(expectedResults);
            ...
            // Assert
            A.CallTo(() => JobProfileSkillSegmentService.GetAllAsync()).MustHaveHappenedOnceExactly();
